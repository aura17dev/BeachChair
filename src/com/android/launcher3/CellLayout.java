...
public class CellLayout extends ViewGroup {
    ...
    public boolean addViewToCellLayout(View child, int index, int childId,
        ...
        if (child instanceof BubbleTextView bubbleChild) {
            boolean enableLabel = mContainerType == HOTSEAT
                    ? PreferenceManager2Kt.firstBlockingCached(pref.getEnableLabelInDock())
                    : true;
    ...
    public boolean isOccupied(int x, int y) {
        if (x >= 0 && x < mCountX && y >= 0 && y < mCountY) {
            return mOccupied.cells[x][y] && !PreferenceManager2Kt.firstBlockingCached(pref.getAllowWidgetOverlap());
        }
    ...
    public boolean isRegionVacant(int x, int y, int spanX, int spanY) {
        return mOccupied.isRegionVacant(x, y, spanX, spanY) || PreferenceManager2Kt.firstBlockingCached(pref.getAllowWidgetOverlap());
    }
