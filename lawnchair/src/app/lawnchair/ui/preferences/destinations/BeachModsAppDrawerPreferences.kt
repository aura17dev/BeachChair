...
/**
 * App-drawer Beach Mods, grouped surface-first: general drawer content, then drawer motion
 * split by lifecycle moment (opening vs browsing).
 */
@Composable
fun BeachModsAppDrawerPreferences(
    ...
    PreferenceLayout(
        ...
        PreferenceGroup {
            Item {
                SwitchPreference(
                    adapter = prefs2.showMostLaunchedRow.getAdapter(),
                    label = stringResource(id = R.string.beach_most_launched_label),
                    description = stringResource(id = R.string.beach_most_launched_description),
                )
            }
        }
        PreferenceGroup(
            heading = stringResource(id = R.string.beach_anim_drawer_open_heading),
        ) {
            Item {
                SwitchPreference(
        ...
        PreferenceGroup(
            heading = stringResource(id = R.string.beach_anim_drawer_browse_heading),
        ) {
            Item {
                ListPreference(
