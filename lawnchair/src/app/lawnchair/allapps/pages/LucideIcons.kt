...
val LucideIconsMap: Map<String, ImageVector> = mapOf(
    "Grid" to Lucide.LayoutGrid,
    "Folder" to Lucide.Folder,
    "Apps" to Lucide.Play,
    "Games" to Lucide.Gamepad2,
    "Social" to Lucide.MessageCircle,
    "Chat" to Lucide.MessageSquare,
    "Tools" to Lucide.Wrench,
    "Settings" to Lucide.Settings,
    "Books" to Lucide.BookOpen,
    "Music" to Lucide.Music,
    "Video" to Lucide.Tv,
    "Photos" to Lucide.Camera,
    "Lifestyle" to Lucide.Heart,
    "Star" to Lucide.Star,
    ...
    "Eye" to Lucide.Eye,
    "File" to Lucide.FileText,
    "Flag" to Lucide.Flag,
    "Gift" to Lucide.Gift,
    "Help" to Lucide.CircleHelp,
    ...
    "Sun" to Lucide.Sun,
    "Trash" to Lucide.Trash2,
    "User" to Lucide.User,
    "VideoCamera" to Lucide.Video,
    "Wifi" to Lucide.Wifi,
    "Search" to Lucide.Search,
    "Bell" to Lucide.Bell,
    "Home" to Lucide.House,
    "Info" to Lucide.Info,
    "Alert" to Lucide.CircleAlert,
